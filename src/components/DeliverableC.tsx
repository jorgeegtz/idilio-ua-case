      ...
      <div className="ops-grid">
        ...
        <div className="ops-card">
          ...
          <ul>
            ...
            <li>Kill: D7 ROAS menor a 20% a $500+ spend.</li>
            <li>Benchmark: CR-15, formato Montaje texto, -29% decay.</li>
            <li>Brief correcto: hook de conflicto familiar + recap en 3s.</li>
          </ul>
        </div>
        <div className="ops-card">
          <div style={{fontSize:20,marginBottom:10}}>📈</div>
          ...
          <ul>
            ...
            <li>Scale trigger: D7 ROAS mayor a 35% AND mROAS mayor a 0.5 por 3 días consecutivos.</li>
            <li>Máximo +20% de budget por semana.</li>
            <li>Hold: ROAS entre 20-35%, monitorear 7 días antes de mover.</li>
            <li>Cut: ROAS menor a 20% a $1K+ spend → reducir 50%.</li>
