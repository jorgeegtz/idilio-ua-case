  ...
  return (
    <section id="deliverable-b">
      ...
      <div className="card memo-body">
        ...
        <div className="highlight-box">Singular gobierna installs y revenue. Plataforma gobierna spend — es lo que se factura. Cuando difieren, Singular tiene razón sobre el outcome; plataforma tiene razón sobre el costo.</div>
